...
function addObjects(){
    // Add users
    users.push({id: 1, name: 'User-1', phone: '055-345-66-77', username: 'u1', password: 'p1'});
    users.push({id: 2, name: 'User-2', phone: '055-345-66-77', username: 'u2', password: 'p2'});
    users.push({id: 3, name: 'User-3', phone: '055-345-66-77', username: 'u3', password: 'p3'});
    users.push({id: 4, name: 'User-4', phone: '055-345-66-77', username: 'u4', password: 'p4'});
    users.push({id: 5, name: 'User-5', phone: '055-345-66-77', username: 'u5', password: 'p5'});
    users.push({id: 6, name: 'Admin', phone: '055-345-66-77', username: 'admin', password: 'admin'});
